...
data class Item(
    @Json(name = "id") val id: Long = NO_ID,
    ...
    @Json(name = "poll") val poll: Long = NO_ID,
    @Json(name = "kids") val kids: List<Long> = emptyList(),
    @Json(name = "url") val url: String = "",
    @Json(name = "score") val score: Int = 0,
    @Json(name = "title") val title: String = "",
    @Json(name = "parts") val parts: List<Long> = emptyList(),
